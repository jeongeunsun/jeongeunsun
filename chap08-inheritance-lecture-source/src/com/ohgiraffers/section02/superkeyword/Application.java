...
public class Application {
    public static void main(String[] args) {
        ...
        *         레퍼런스 변수로 자식클래스 내의 모든 생성자와 메소드 내에서 선언하지 않고도
        *         사용할 수 있는 레퍼런스 변수이다.
        ...
        * */
        ...
        Product product2 = new Product("S-01234","삼성","갤럭시폴Z드5",3590000, new Date());
        ...
        Computer computer2 = new Computer("퀼컴 스냄드래곤", 512,12,"안드로이드");
