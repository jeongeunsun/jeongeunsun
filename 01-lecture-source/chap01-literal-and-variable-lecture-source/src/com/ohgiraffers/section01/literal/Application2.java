...
public class Application2 {
    ...
    public static void main(String[] args){
        ...
        System.out.println(10/3); //몫 값이 나온다
        System.out.println(10%3); //나머지 값이 나온다
        ...
        /* 2. 문자의 연산 */
        /* 2-1 문자와 문자의 연산 */
        /* 문자끼리의 연산도 사직연산에 나머지를 구하는 연산까지 가능하다 */
        ...
        * */
        ...
        /* 2-3 문자와 실수와의 연산 */
        /* 실수도 숫자이기 때문에 정수와 연산처럼 모든 연산이 가능하다 */
        ...
        /* 3. 문자열의 연산 */
        /* 3-1 문자열과 문자열의 연산 */
        /* 문자열과 문자열의 '+' 연산결과는 문자열 합치기(이어붙이기)가 된다 */
        ...
        /* 문자열과 연산은 '+' 연산만 가능하다 */
        /* 연산 결과는 다른 형태의 값들도 문자열로 취급하여 이어붙이기(문자열 합치기) 결과가 나오게 된다. */
        ...
        /* 이유는 문자는 내부적으로 숫자 취급을 하기 때문에 결국 논리값과 숫자의 연산과 동일하다 */
