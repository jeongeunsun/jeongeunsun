...
public class FinalFieldTest {
    ...
    /* final키워드에 대해 이해할 수 있다. */
    /*
    * final
    * : final은 종단의 의미를 가지는 키워드이다.
    * final키워드를 사용할 수 있는 위치는 다양한 편이며 의미가 약간은 다르지만, 결국 변경 불가의 이미이다.
    ...
    * final키워드 사용시 초기화를 하지 않으면 에러가 발생한다.
    * */

    //private static final int STATIC_NUM; //에러남 //0으로 초기화 되기 떄문에 이후 값 변경 불가
