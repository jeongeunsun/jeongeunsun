...
public class Application {
    public static void main(String[] args) {
        ...
        * 기본생성자는 compiler에서 자동으로 추가되기 때문에 지금 껏 명시적으로 작성하지 않고 사용할 수 있었다.
        * 인스턴스 생성 시 별도로 수행할 명령이 없었기 때문에 아무것도 작서하지 않은 것이다.
        * */
        ...
        * */
        User user1 = new User();
        System.out.println(user1.getinformaiton());

        /* 매개 변수를 전달 받는 생성자를 호출해 인스턴스 생성 후 필드값 출력 */
        User user2 = new User("user01","pass01","홍길동");
        // 위에 값들로 초기화 바로 시켜주겠다
        System.out.println(user2.getinformaiton());
