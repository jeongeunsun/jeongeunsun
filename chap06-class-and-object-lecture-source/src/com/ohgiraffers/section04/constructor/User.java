...
public class User {
    ...
    private String pwd;
    private String name;
    private  java.util.Date enrollDate; //날짜 나오는 함수
    ...
    * */
    ...
    /* 주의사항. 동일한 이름의 생성자 혹은 메소드를 한 클래스 안에서 작성하는 것은 불가능하디. (컴파일에러) */
    //public User(){}

    /* 2. 매개변수 있는 생성자 */
    /* id, pwd, name의 초기화를 담당할 생성자 */
    public User(String id, String pwd, String name){
        //타입 갯수 순서를 다르게하면 동일한 이름의 생성자 작성 가능
        this.id = id;
        this.name = name;
        this.pwd = pwd;

        System.out.println("id, pwd, name을 초기화하는 생성자 호출함....");

    }
    public User(String id){} //타입 갯수 순서를 다르게하면 동일한 이름의 생성자 작성 가능
