...
public class Application {
    public static void main(String[] args) {
        ...
        /* gerTime() : 1970년 1월 1일 0시 0분 0초를 지난 시간을 millisecond로 계산해서 long타입으로 반환한다. */

        System.out.println("today.getTime() = " + today.getTime()); //1712127116108

        Date time = new Date(1712127116108L);
