...
public class Application1 {
    public static void main(String[] args) {
        ...
        * */
        ...
        System.out.println("contact() : " + (str2.concat(str5)));
        ...
        * */
        ...
        System.out.println("caseStr = " + caseStr); //원문에 영향을 주지 않는다.
        ...
        * */
        ...
        System.out.println("substring(3, 6)" + javaoracle.substring(3, 6)); //aor  > 3부터 6전까지
        ...
        System.out.println("replace() : " + javaoracle.replace("java", ""));    //
        ...
        System.out.println("빈 문자열의 길이 : " + ("  ".length()));   //2
